...
export const chefProfile: ChefProfile = {
  ...
  avatar: "/food/chef-avatar.jpg",
  banner: "/food/chef-banner.jpg",
};
...
export const bundles: Bundle[] = [
  { id: 1, name: "Family Dinner for 4", image: "/food/mansaf.jpg", items: 5, price: 65, status: "published" },
  { id: 2, name: "Weekly Meal Prep", image: "/food/baklava.jpg", items: 7, price: 75, status: "published" },
  { id: 3, name: "Mezze Tasting Plate", image: "/food/mansaf.jpg", items: 4, price: 42, status: "draft" },
  { id: 4, name: "Sweet Tooth Box", image: "/food/baklava.jpg", items: 3, price: 32, status: "published" },
];
...
export const orderDetails: Record<string, OrderDetailData> = {
  "1042": {
    ...
    customer: {
      name: "Sarah Khan",
      avatar: "/food/avatar-female2.jpg",
      phone: "+14695550142",

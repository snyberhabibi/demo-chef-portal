...
const PRODUCTS = [
  {
    ...
    price: "$18.99",
    shopUrl: "https://www.webstaurantstore.com/search/catering-bags.html",
  },
  {
    id: 2,
    ...
    price: "$14.99",
    shopUrl: "https://www.webstaurantstore.com/search/half-tray-boxes.html",
  },
  {
    id: 3,
    ...
    price: "$22.99",
    shopUrl: "https://www.webstaurantstore.com/search/full-tray-boxes.html",
  },
  {
    id: 4,
    ...
    price: "$29.99",
    shopUrl: "https://www.webstaurantstore.com/search/to-go.html",
  },
];
...
export default function PackagingPage() {
  ...
  return (
    <div className="content-default section-stack">
      {/* Intro */}
      <div>
        <h1 className="heading-lg">Packaging Supplies</h1>
      ...
      <div className="card-sticker" style={{ textAlign: "center" }}>
        ...
        <button className="btn btn-dark btn-lg" onClick={handleBrandedRequest}>
          {requestSent ? (

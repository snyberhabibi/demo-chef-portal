...
interface BundleAvailabilitySectionProps {
...
export function BundleAvailabilitySection({
  formData,
  onUpdate,
  errors = {},
}: BundleAvailabilitySectionProps) {
    ...
    <Card>
      ...
      <div>
        ...
        <HelpText className="mb-[var(--p-space-300)]">
          Select which days this bundle is available. Leave all unchecked for every day.
        </HelpText>
